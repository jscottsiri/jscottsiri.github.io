                        ...
                        <div class="content-subsection">
                            <div id="personal-split" class="content-section-split big-unsplit">
                                <div class="image-container">
                                    <img draggable="false" id="profile-pic" src="/public/ScottatHorseland.jpg" alt="Scott Siri, at the Assateague State Park (no horses)">
                ...
                <div class="content-section-body">
                    <div class="content-subsection">
                        <div id="UU" class="long-tile no-copy">
                            <div class="image-container">
                                <img alt="Utrecht University Logo" src="/public/UtrechtUniversity.jpg" draggable="false">
                            </div>
                            <div>
                        ...
                        <div id="NJIT" class="long-tile no-copy">
                            <div class="image-container">
                                <img alt="NJIT Logo" src="/public/NJIT.jpg" draggable="false">
                            </div>
                            <div>
                ...
                <div class="content-section-body">
                    <div class="content-subsection">
                        <div id="SMF" class="long-tile no-copy">
                            <div class="image-container">
                                <img alt="SportsMainFrame Logo" src="/public/SportsMainFrame.jpg" draggable="false">
                            </div>
                            <div>
                        ...
                        <div id="TNO" class="long-tile no-copy">
                            <div class="image-container">
                                <img alt="TNO Logo" src="/public/TNO.jpg" draggable="false">
                            </div>
                            <div>
                        ...
                        <div id="GP" class="long-tile no-copy">
                            <div class="image-container">
                                <img alt="GraphPolaris Logo" src="/public/GraphPolaris.jpg" draggable="false">
                            </div>
                            <div>
                        ...
                        <div id="ADP" class="long-tile no-copy">
                            <div class="image-container">
                                <img alt="ADP Logo" src="/public/ADP.jpg" draggable="false">
                            </div>
                            <div>
        ...
        <section id="project-UU" class="project fade-in-element hidden" >
            ...
            <div class="project-content card" >
                <div class="project-summary project-section" id="project-summary">
                    <div id="project-img">
                        <div class="image-container">
                            <img alt="Utrecht University Logo" height="160px" src="/public/UtrechtUniversity.jpg" draggable="false">
                        </div>
                    </div>
        ...
        <section id="project-NJIT" class="project fade-in-element hidden" >
            ...
            <div class="project-content card" >
                <div class="project-summary project-section" id="project-summary">
                    <div id="project-img">
                        <div class="image-container">
                            <img alt="NJIT Logo" height="160px" src="/public/NJIT.jpg" draggable="false">
                        </div>
                    </div>
                    <div id="project-details">
